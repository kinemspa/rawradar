...
const AUS_PATH = "M 200 90 L 220 85 L 240 88 L 260 95 L 280 100 L 300 108 L 320 115 L 340 120 L 360 125 L 370 130 L 380 140 L 390 155 L 395 170 L 398 185 L 400 200 L 400 215 L 398 230 L 395 245 L 390 260 L 385 275 L 380 290 L 375 305 L 370 315 L 365 325 L 355 335 L 345 340 L 335 342 L 325 338 L 315 332 L 305 325 L 295 318 L 285 312 L 275 308 L 265 305 L 255 300 L 245 295 L 238 288 L 232 278 L 228 268 L 225 258 L 222 248 L 220 238 L 215 228 L 210 218 L 205 208 L 200 195 L 195 182 L 190 170 L 185 160 L 180 150 L 178 140 L 178 130 L 180 120 L 185 110 L 195 100 Z";

function project(lat,lon){
  const x=(lon-112)/43*800;
  const y=(45-lat)/35*680;
  return {x,y};
}
