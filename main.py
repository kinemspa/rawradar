...
<div id="map-container" style="width:100%;aspect-ratio:820/680;max-height:70vh;position:relative"><svg id="map-svg" style="width:100%;height:100%" viewBox="0 0 820 680" preserveAspectRatio="xMidYMid meet"></svg><div id="map-loading" style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;color:#71717a;font-size:16px">Loading stations...</div></div>
</div>
